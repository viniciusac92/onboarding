...
const PartnersMiddleColumn: React.FC = () => {
    ...
    return (
        <div className="responsive-column px-4 space-y-4 md:space-y-6">
            <h1 className="responsive-page-title text-3xl font-bold mb-[12px]">Seus sócios</h1>
            ...
            {showShareModal && (
                <Card className="relative rounded border-none mb-6">
                    ...
                    <CardContent className="pt-0 mt-0">
                        <p className="text-sm mb-4">Você pode compartilhar essa página para seu sócio preencher de onde estiver!</p>
                    ...
                    <CardHeader className="p-4 pb-0">
                        <div className="flex justify-between items-center">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                >
                                    {partner.isExpanded ? <ChevronUp size={16} /> : <ChevronDown size={16} />}
                                </Button>
                            </div>
                        </div>
                    </CardHeader>
            ...
            <Button 
                ...
                className="flex items-center justify-center gap-2 w-full bg-blue-500 hover:bg-blue-600 text-white"
            >
                <Share2 size={16} />
