          ...
          <CardContent className="pt-0 mt-0 flex-1 overflow-y-auto">
            <div className="flex flex-row gap-4 mb-4">
              <div className="flex-1 max-w-[128px]">
                ...
                <Input readOnly value={cep} className="focus-visible:ring-0 w-full bg-gray-100" />
              </div>
              <div className="flex-1 ">
                <Label className="block font-bold mb-1.5">Cidade</Label>
                <Input readOnly value={cidade} className="focus-visible:ring-0 w-full bg-gray-100" />
              </div>
              <div className="flex-1 max-w-[47px]">
                <Label className="block font-bold mb-1.5">Estado</Label>
                <Input readOnly value={estado} className="focus-visible:ring-0 w-full bg-gray-100" />
              </div>
            </div>
            <div className="flex flex-row gap-4 mb-4">
              <div className="flex-1">
                <Label className="block font-bold mb-1.5">Logradouro</Label>
                <Input readOnly value={logradouro} className="focus-visible:ring-0 w-full bg-gray-100" />
              </div>
              <div className="flex-1 max-w-[205px]">
                <Label className="block font-bold mb-1.5">Bairro</Label>
                <Input readOnly value={bairro} className="focus-visible:ring-0 w-full bg-gray-100" />
              </div>
              <div className="flex-1 max-w-[53px]">
                <Label className="block font-bold mb-1.5">Número</Label>
                <Input readOnly value={numero} className="focus-visible:ring-0 w-full bg-gray-100" />
              </div>
            </div>
            <div className="flex-1 max-w-[262px]">
              <Label className="block font-bold mb-1.5">Complemento</Label>
              <Input readOnly value={complemento} className="focus-visible:ring-0 w-full bg-gray-100" />
            </div>
            <div className="mt-4">
